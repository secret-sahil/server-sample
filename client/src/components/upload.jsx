					...
					>
						...
						>
							<p className="z-10 text-xs font-light text-center text-gray-500">
								{getFile ? getFile.name : 'Drag & Drop your files here'}
							</p>
							<svg
                            ...
                            <div className={getFile ? 'flex justify-evenly' : 'hidden'}>
                                <button onClick={uploadFile} type='button' className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-[45%] mt-20">
                                    Upload
                                </button>
                                <button onClick={removeFile} type='button' className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-[45%] mt-20">
                                    Remove File
                                </button>
                            </div>
					</form>
